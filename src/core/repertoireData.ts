...
export const REPERTOIRE_CATEGORIES: CategoryInfo[] = [
  ...
  {
    id: 'Forró, Xote & Baião',
    label: 'Forró, Xote & Baião (Luiz Gonzaga, Dominguinhos & Trio Nordestino)',
    shortLabel: 'Forró & Xote',
    iconName: 'Sun',
    badge: '5 Obras',
    description: 'O pulsar de Asa Branca, Sabiá, Eu Só Quero um Xodó, Riacho do Navio e O Xote das Meninas com síncopes de sanfona e zabumba.',
  },
  {
    id: 'Seresta & Brega (Zezo dos Teclados)',
    label: 'Seresta & Brega (Zezo Potiguar, Reginaldo Rossi & Bartô Galeno)',
    shortLabel: 'Seresta & Brega',
    iconName: 'Radio',
    badge: '5 Obras',
    description: 'O teclado arranjador inconfundível de Zezo dos Teclados, Reginaldo Rossi e Bartô Galeno: As Dores do Amor, Garçon, A Raposa e as Uvas, Leviana e Diga Pra Mim.',
  },
  {
  ...
  {
    id: 'Reggae & Praieiro',
    label: 'Reggae & Praieiro (Bob Marley & The Wailers)',
    shortLabel: 'Reggae',
    iconName: 'Waves',
    badge: '3 Obras',
    description: 'A cadência do contratempo jamaicano e linhas melódicas de baixo: Three Little Birds, Is This Love e No Woman No Cry.',
  },
  {
  ...
  },
  {
    ...
    label: 'Rock Anos 80 & New Wave (The Police, Bruce Springsteen, a-ha & Eurythmics)',
    shortLabel: 'Anos 80 / New Wave',
    iconName: 'Zap',
    badge: '6 Obras',
    description: 'Riffs lendários de sintetizadores dos anos 80, pulso staccato e New Wave: Dancing in the Dark, Take On Me, Sweet Dreams e Every Breath You Take.',
  },
  {
  ...
  },
  {
    ...
    label: 'Rock Psicodélico & Progressivo (Pink Floyd, The Doors & Mestres)',
    shortLabel: 'Rock Psicodélico',
    iconName: 'Flame',
    badge: '11 Obras',
    description: 'Obras transcendentais de Pink Floyd (Comfortably Numb, Wish You Were Here, The Wall) e The Doors (Light My Fire, Riders on the Storm, People Are Strange) com camadas atmosféricas e arpejos imersivos.',
  },
];
  ...
  },
  {
    ...
    extension: {
      audit: {
        status: 'VALIDATED',
        auditedAt: '2026-09-26',
        notes: 'Asa Branca auditada e validada segundo partitura histórica de Humberto Teixeira e gravação original de Luiz Gonzaga (RCA Victor, 1947).',
        sources: [
          'Gonzaga, Luiz & Teixeira, Humberto. Asa Branca (RCA Victor, matriz B-1011, 1947)',
          'Cancioneiro Gonzagueano (Fundação Joaquim Nabuco)',
        ],
        melodyVerified: true,
        harmonyVerified: true,
        rhythmVerified: true,
        musicalForm: 'Baião Tradicional Nordestino em 24 Compassos (A - A1 - B)',
      },
      credits: {
      ...
      lyrics: [
        {
          text: 'Quan-do o-lhei a ter-ra ar-den-do',
          startMeasure: 1,
          endMeasure: 2,
          startBeat: 1,
          endBeat: 9,
          lineType: 'verse',
          words: [
            { text: 'Quan - do', startBeat: 1, endBeat: 2 },
            { text: 'o - lhei', startBeat: 2, endBeat: 4 },
            { text: 'a', startBeat: 4, endBeat: 5 },
            { text: 'ter - ra', startBeat: 5, endBeat: 7 },
            { text: 'ar - den - do', startBeat: 7, endBeat: 9 },
          ],
        },
        {
          text: 'qual a fo-guei-ra de São Jo-ão',
          startMeasure: 3,
          endMeasure: 4,
          startBeat: 9,
          endBeat: 17,
          lineType: 'verse',
          words: [
            { text: 'qual', startBeat: 9, endBeat: 9.5 },
            { text: 'a', startBeat: 9.5, endBeat: 10 },
            { text: 'fo - guei - ra', startBeat: 10, endBeat: 13 },
            { text: 'de', startBeat: 13, endBeat: 14 },
            { text: 'São', startBeat: 14, endBeat: 15 },
            { text: 'Jo - ão', startBeat: 15, endBeat: 17 },
          ],
        },
        {
          text: 'Eu per-gun-tei a Deus do céu, ai',
          startMeasure: 5,
          endMeasure: 6,
          startBeat: 17,
          endBeat: 25,
          lineType: 'verse',
          words: [
            { text: 'Eu', startBeat: 17, endBeat: 17.5 },
            { text: 'per - gun - tei', startBeat: 17.5, endBeat: 20 },
            { text: 'a', startBeat: 20, endBeat: 21 },
            { text: 'Deus', startBeat: 21, endBeat: 22 },
            { text: 'do', startBeat: 22, endBeat: 23 },
            { text: 'céu,', startBeat: 23, endBeat: 24 },
            { text: 'ai', startBeat: 24, endBeat: 25 },
          ],
        },
        {
          text: 'por que ta-ma-nha ju-di-a-ção',
          startMeasure: 7,
          endMeasure: 8,
          startBeat: 25,
          endBeat: 33,
          lineType: 'verse',
          words: [
            { text: 'por', startBeat: 25, endBeat: 26 },
            { text: 'que', startBeat: 26, endBeat: 27 },
            { text: 'ta - ma - nha', startBeat: 27, endBeat: 29 },
            { text: 'ju - di - a - ção', startBeat: 29, endBeat: 33 },
          ],
        },
        {
          text: 'Que bra-sei-ro, que for-na-ia',
          startMeasure: 9,
          endMeasure: 10,
          startBeat: 33,
          endBeat: 41,
          lineType: 'verse',
          words: [
            { text: 'Que', startBeat: 33, endBeat: 33.5 },
            { text: 'bra - sei - ro,', startBeat: 33.5, endBeat: 36 },
            { text: 'que', startBeat: 36, endBeat: 37 },
            { text: 'for - na - ia', startBeat: 37, endBeat: 41 },
          ],
        },
        {
          text: 'nem um pé de pran-ta-ção',
          startMeasure: 11,
          endMeasure: 12,
          startBeat: 41,
          endBeat: 49,
          lineType: 'verse',
          words: [
            { text: 'nem', startBeat: 41, endBeat: 41.5 },
            { text: 'um', startBeat: 41.5, endBeat: 42 },
            { text: 'pé', startBeat: 42, endBeat: 43 },
            { text: 'de', startBeat: 43, endBeat: 44 },
            { text: 'pran - ta - ção', startBeat: 44, endBeat: 49 },
          ],
        },
        {
          text: "Por fal-ta d'á-gua per-di meu ga-do",
          startMeasure: 13,
          endMeasure: 14,
          startBeat: 49,
          endBeat: 57,
          lineType: 'verse',
          words: [
            { text: 'Por', startBeat: 49, endBeat: 49.5 },
            { text: 'fal - ta', startBeat: 49.5, endBeat: 51 },
            { text: "d'á - gua", startBeat: 51, endBeat: 53 },
            { text: 'per - di', startBeat: 53, endBeat: 55 },
            { text: 'meu', startBeat: 55, endBeat: 56 },
            { text: 'ga - do', startBeat: 56, endBeat: 57 },
          ],
        },
        {
          text: 'mor-reu de se-de meu a-la-zão',
          startMeasure: 15,
          endMeasure: 16,
          startBeat: 57,
          endBeat: 65,
          lineType: 'verse',
          words: [
            { text: 'mor - reu', startBeat: 57, endBeat: 59 },
            { text: 'de', startBeat: 59, endBeat: 60 },
            { text: 'se - de', startBeat: 60, endBeat: 61 },
            { text: 'meu a - la - zão', startBeat: 61, endBeat: 65 },
          ],
        },
        {
          text: 'A-té mes-mo a a-sa bran-ca',
          startMeasure: 17,
          endMeasure: 18,
          startBeat: 65,
          endBeat: 73,
          lineType: 'chorus',
          words: [
            { text: 'A - té', startBeat: 65, endBeat: 66 },
            { text: 'mes - mo', startBeat: 66, endBeat: 68 },
            { text: 'a', startBeat: 68, endBeat: 69 },
            { text: 'a - sa', startBeat: 69, endBeat: 71 },
            { text: 'bran - ca', startBeat: 71, endBeat: 73 },
          ],
        },
        {
          text: 'ba-teu a-sas do ser-tão',
          startMeasure: 19,
          endMeasure: 20,
          startBeat: 73,
          endBeat: 81,
          lineType: 'chorus',
          words: [
            { text: 'ba - teu', startBeat: 73, endBeat: 74 },
            { text: 'a - sas', startBeat: 74, endBeat: 76 },
            { text: 'do', startBeat: 76, endBeat: 77 },
            { text: 'ser - tão', startBeat: 77, endBeat: 81 },
          ],
        },
        {
          text: 'En-ton-ce eu dis-se: a-deus, Ro-si-nha',
          startMeasure: 21,
          endMeasure: 22,
          startBeat: 81,
          endBeat: 89,
          lineType: 'chorus',
          words: [
            { text: 'En - ton - ce', startBeat: 81, endBeat: 82.5 },
            { text: 'eu', startBeat: 82.5, endBeat: 83 },
            { text: 'dis - se:', startBeat: 83, endBeat: 85 },
            { text: 'a - deus,', startBeat: 85, endBeat: 87 },
            { text: 'Ro - si - nha', startBeat: 87, endBeat: 89 },
          ],
        },
        {
          text: 'guar-da con-ti-go meu co-ra-ção',
          startMeasure: 23,
          endMeasure: 24,
          startBeat: 89,
          endBeat: 97,
          lineType: 'chorus',
          words: [
            { text: 'guar - da', startBeat: 89, endBeat: 91 },
            { text: 'con - ti - go', startBeat: 91, endBeat: 93 },
            { text: 'meu co - ra - ção', startBeat: 93, endBeat: 97 },
          ],
        },
      ],
    },
