...
export interface CourseExercise {
  id: string;
  title: string;
  goal: string;                 // Objetivo claro do exercício pedagógico
  type: 'notes' | 'rhythm' | 'phrase' | 'chords' | 'bimanual';
  bpm: number;
  timeSignature: string;        // '4/4' | '3/4' | '2/4'
  accompanimentStyleId?: string; // Estilo rítmico opcional (ex: 'pop-ballad', 'waltz', 'eight-beat', 'pop-rock')
  scoreTrack?: ScoreNote[];     // Partitura interativa do exercício
  targetChords?: Array<{
    root: string;
    quality: string;
    inversion: 0 | 1 | 2;
  ...
  evaluationCriteria: {
    minAccuracyPercent: number; // Porcentagem mínima de acertos (ex: 80%)
    targetPrecisionMs: number;  // Tolerância temporal alvo (ex: 150ms)
    description: string;
  };
}
...
export interface CourseLesson {
  ...
  scoreTrack?: ScoreNote[];   // Notas para a Partitura Deslizante (exercício principal)
  exercises?: CourseExercise[]; // Múltiplos exercícios estruturados por aula
    ...
    lessons: [
      {
        ...
        durationMinutes: 8,
        instructions: {
          heading: 'O Segredo Visual do Teclado & A Origem das Notas',
          text: 'O teclado moderno organiza as 12 frequências sonoras da música ocidental em um padrão visual alternado de teclas brancas e pretas, derivado do sistema medieval das 7 notas naturais criado pelo monge Guido d\'Arezzo.',
          bulletPoints: [
            'As 7 Notas Naturais (Dó, Ré, Mi, Fá, Sol, Lá, Si) ocupam as teclas brancas diatônicas.',
            'As 5 Notas Acidentadas ocupam as teclas pretas, agrupadas em pares de 2 e trios de 3 ao longo de cada oitava.',
            'Enarmonia no Teclado: Cada tecla preta tem dois nomes possíveis conforme o contexto (ex: a tecla entre C e D é C# ao subir ou D♭ ao descer).',
            'Âncoras Geométricas: A nota Dó (C) fica sempre imediatamente à esquerda das 2 teclas pretas; a nota Fá (F) fica sempre à esquerda das 3 pretas.',
            'Dó Central (C3): Pousado no centro do teclado, serve de fronteira acústica entre o grave e o agudo e referência postural do instrumentista.',
          ],
          fingeringTip: 'Use o dedo 1 (polegar) da mão direita no Dó Central (C3), mantendo a palma arredondada.',
        ...
        exercises: [
          {
            id: 't1-1-ex1',
            title: 'Exercício 1: Ataque & Topografia das Teclas',
            goal: 'Identificar a posição das notas no teclado e atacar com firmeza e postura correta.',
            type: 'notes',
            bpm: 65,
            timeSignature: '4/4',
            scoreTrack: [
            ...
            { midi: 67, clef: 'treble', duration: 2, beat: 1, measure: 3, fingerRightHand: 5, noteName: 'G3' },
            { midi: 65, clef: 'treble', duration: 2, beat: 3, measure: 3, fingerRightHand: 4, noteName: 'F3' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 80,
              targetPrecisionMs: 160,
              description: 'Acertar ao menos 80% das notas mantendo as articulações dos dedos firmes.',
            },
          },
          {
            id: 't1-1-ex2',
            title: 'Exercício 2: Pulso Rítmico com Metrônomo',
            goal: 'Manter andamento uniforme no clique do metrônomo sem hesitações nos tempos fortes.',
            type: 'rhythm',
            bpm: 75,
            timeSignature: '4/4',
            scoreTrack: [
            ...
            evaluationCriteria: {
              ...
              targetPrecisionMs: 130,
              description: 'Sincronizar os ataques rigorosamente com o clique do metrônomo.',
            },
          },
          {
            id: 't1-1-ex3',
            title: 'Exercício 3: Frase Musical Completa',
            goal: 'Executar a frase melódica completa com legato, fluidez e dinâmica expressiva.',
            type: 'phrase',
            bpm: 80,
            timeSignature: '4/4',
            accompanimentStyleId: 'pop-ballad',
            scoreTrack: [
          { midi: 60, clef: 'treble', duration: 1, beat: 1, measure: 1, fingerRightHand: 1, noteName: 'C3' },
          { midi: 62, clef: 'treble', duration: 1, beat: 2, measure: 1, fingerRightHand: 2, noteName: 'D3' },
          { midi: 64, clef: 'treble', duration: 1, beat: 3, measure: 1, fingerRightHand: 3, noteName: 'E3' },
          ...
          { midi: 60, clef: 'treble', duration: 2, beat: 2, measure: 3, fingerRightHand: 1, noteName: 'C3' },
            ...
            evaluationCriteria: {
              minAccuracyPercent: 85,
              targetPrecisionMs: 110,
              description: 'Executar a melodia integral sem interrupções com precisão e musicalidade.',
            },
          },
        ],
      },
      {
        ...
        exercises: [
          ...
          },
          {
            ...
            { midi: 67, clef: 'treble', duration: 1, beat: 2, measure: 2, fingerRightHand: 5, noteName: 'G3' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 85,
              targetPrecisionMs: 130,
        ...
        exercises: [
          {
            ...
            timeSignature: '4/4',
            scoreTrack: [
            { midi: 64, clef: 'treble', duration: 2, beat: 1, measure: 1, fingerRightHand: 1, noteName: 'E3' },
            { midi: 67, clef: 'treble', duration: 2, beat: 3, measure: 1, fingerRightHand: 2, noteName: 'G3' },
            { midi: 71, clef: 'treble', duration: 2, beat: 1, measure: 2, fingerRightHand: 4, noteName: 'B3' },
            { midi: 74, clef: 'treble', duration: 2, beat: 3, measure: 2, fingerRightHand: 5, noteName: 'D4' },
            { midi: 71, clef: 'treble', duration: 2, beat: 1, measure: 3, fingerRightHand: 4, noteName: 'B3' },
            { midi: 67, clef: 'treble', duration: 2, beat: 3, measure: 3, fingerRightHand: 2, noteName: 'G3' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 80,
              targetPrecisionMs: 160,
          ...
          },
          {
            ...
            { midi: 67, clef: 'treble', duration: 1, beat: 2, measure: 2, fingerRightHand: 2, noteName: 'G3' },
            { midi: 64, clef: 'treble', duration: 1, beat: 3, measure: 2, fingerRightHand: 1, noteName: 'E3' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 85,
              targetPrecisionMs: 130,
        ...
        exercises: [
          {
            ...
            { midi: 64, clef: 'treble', duration: 2, beat: 3, measure: 1, fingerRightHand: 3, noteName: 'E3' },
            { midi: 65, clef: 'treble', duration: 2, beat: 1, measure: 2, fingerRightHand: 4, noteName: 'F3' },
            { midi: 67, clef: 'treble', duration: 2, beat: 3, measure: 2, fingerRightHand: 5, noteName: 'G3' },
            { midi: 67, clef: 'treble', duration: 2, beat: 1, measure: 3, fingerRightHand: 5, noteName: 'G3' },
            { midi: 65, clef: 'treble', duration: 2, beat: 3, measure: 3, fingerRightHand: 4, noteName: 'F3' },
          ],
        ...
        exercises: [
          {
            ...
            { midi: 55, clef: 'bass', duration: 2, beat: 1, measure: 2, fingerLeftHand: 1, noteName: 'G2' },
            { midi: 52, clef: 'bass', duration: 2, beat: 3, measure: 2, fingerLeftHand: 3, noteName: 'E2' },
            { midi: 48, clef: 'bass', duration: 2, beat: 1, measure: 3, fingerLeftHand: 5, noteName: 'C2' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 80,
              targetPrecisionMs: 160,
          ...
          },
          {
            ...
            { midi: 52, clef: 'bass', duration: 1, beat: 2, measure: 1, fingerLeftHand: 3, noteName: 'E2' },
            { midi: 55, clef: 'bass', duration: 1, beat: 3, measure: 1, fingerLeftHand: 1, noteName: 'G2' },
            { midi: 52, clef: 'bass', duration: 1, beat: 4, measure: 1, fingerLeftHand: 3, noteName: 'E2' },
            { midi: 48, clef: 'bass', duration: 1, beat: 1, measure: 2, fingerLeftHand: 5, noteName: 'C2' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 85,
              targetPrecisionMs: 130,
        ...
        exercises: [
          {
            ...
            scoreTrack: [
            { midi: 48, clef: 'bass', duration: 2, beat: 1, measure: 1, fingerLeftHand: 5, noteName: 'C2' },
            { midi: 43, clef: 'bass', duration: 2, beat: 3, measure: 1, fingerLeftHand: 5, noteName: 'G1' },
            { midi: 45, clef: 'bass', duration: 2, beat: 1, measure: 2, fingerLeftHand: 4, noteName: 'A1' },
            { midi: 41, clef: 'bass', duration: 2, beat: 3, measure: 2, fingerLeftHand: 5, noteName: 'F1' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 80,
              targetPrecisionMs: 160,
          ...
          },
          {
            ...
            scoreTrack: [
            { midi: 48, clef: 'bass', duration: 1, beat: 1, measure: 1, fingerLeftHand: 5, noteName: 'C2' },
            { midi: 43, clef: 'bass', duration: 1, beat: 2, measure: 1, fingerLeftHand: 5, noteName: 'G1' },
            { midi: 45, clef: 'bass', duration: 1, beat: 3, measure: 1, fingerLeftHand: 4, noteName: 'A1' },
            { midi: 41, clef: 'bass', duration: 1, beat: 4, measure: 1, fingerLeftHand: 5, noteName: 'F1' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 85,
              targetPrecisionMs: 130,
        ...
        exercises: [
          {
            ...
            { midi: 55, clef: 'bass', duration: 2, beat: 3, measure: 2, fingerLeftHand: 1, noteName: 'G2' },
            { midi: 64, clef: 'treble', duration: 2, beat: 1, measure: 3, fingerRightHand: 3, noteName: 'E3' },
            { midi: 65, clef: 'treble', duration: 2, beat: 3, measure: 3, fingerRightHand: 4, noteName: 'F3' },
          ],
            evaluationCriteria: {
          ...
          },
          {
            ...
            { midi: 64, clef: 'treble', duration: 1, beat: 1, measure: 2, fingerRightHand: 3, noteName: 'E3' },
            { midi: 65, clef: 'treble', duration: 1, beat: 2, measure: 2, fingerRightHand: 4, noteName: 'F3' },
            { midi: 48, clef: 'bass', duration: 1, beat: 3, measure: 2, fingerLeftHand: 5, noteName: 'C2' },
            { midi: 67, clef: 'treble', duration: 1, beat: 4, measure: 2, fingerRightHand: 5, noteName: 'G3' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 85,
              targetPrecisionMs: 130,
    ...
    lessons: [
      {
        ...
        durationMinutes: 12,
        instructions: {
          heading: 'Os Graus da Escala & A Fórmula das Tríades Maiores',
          text: 'Na música ocidental, os sons organizam-se em 8 graus consecutivos (I Tônica, II Supertônica, III Mediante, IV Subdominante, V Dominante, VI Superdominante, VII Sensível e VIII Oitava). Os acordes simples são tríades formadas pelos graus ímpares I, III e V.',
          bulletPoints: [
            'Arquitetura Intervalar: Uma tríade maior é formada pela Tônica (I) + Terça Maior (III, 2 tons / 4 semitons) + Quinta Justa (V, 3,5 tons / 7 semitons).',
            'Relação Interna: Do I ao III grau há 2 tons inteiros; do III ao V grau há 1 tom e meio. Essa combinação gera um som aberto, luminoso e consonante.',
            'Shape Visual 1-3-5: Os dedos 1 (polegar), 3 (médio) e 5 (mínimo) repousam em teclas alternadas da escala.',
            'Tríades Maiores Puras nas Teclas Brancas: Dó Maior (C-E-G), Fá Maior (F-A-C) e Sol Maior (G-B-D).',
          ],
          fingeringTip: 'Polegar na fundamental (grau I), dedo 3 na terça (grau III), dedo 5 na quinta (grau V).',
        },
        scoreTrack: [
          { midi: 60, clef: 'treble', duration: 1, beat: 1, measure: 1, fingerRightHand: 1, noteName: 'C3', chordName: 'C' },
          { midi: 64, clef: 'treble', duration: 1, beat: 2, measure: 1, fingerRightHand: 3, noteName: 'E3', chordName: 'C' },
          { midi: 67, clef: 'treble', duration: 2, beat: 3, measure: 1, fingerRightHand: 5, noteName: 'G3', chordName: 'C' },
          { midi: 65, clef: 'treble', duration: 1, beat: 1, measure: 2, fingerRightHand: 1, noteName: 'F3', chordName: 'F' },
          { midi: 69, clef: 'treble', duration: 1, beat: 2, measure: 2, fingerRightHand: 3, noteName: 'A3', chordName: 'F' },
          { midi: 72, clef: 'treble', duration: 2, beat: 3, measure: 2, fingerRightHand: 5, noteName: 'C4', chordName: 'F' },
          { midi: 67, clef: 'treble', duration: 1, beat: 1, measure: 3, fingerRightHand: 1, noteName: 'G3', chordName: 'G' },
          { midi: 71, clef: 'treble', duration: 1, beat: 2, measure: 3, fingerRightHand: 3, noteName: 'B3', chordName: 'G' },
          { midi: 74, clef: 'treble', duration: 2, beat: 3, measure: 3, fingerRightHand: 5, noteName: 'D4', chordName: 'G' },
          { midi: 60, clef: 'treble', duration: 4, beat: 1, measure: 4, fingerRightHand: 1, noteName: 'C3', chordName: 'C' },
        ],
        exercises: [
          {
            id: 't4-1-ex1',
            title: 'Exercício 1: Tríade Fundamental de Dó Maior (C - E - G)',
            goal: 'Identificar e atacar a fundamental, terça maior e quinta justa de Dó Maior.',
            type: 'notes',
            bpm: 65,
            timeSignature: '4/4',
            scoreTrack: [
          ...
          { midi: 67, clef: 'treble', duration: 4, beat: 1, measure: 2, fingerRightHand: 5, noteName: 'G3' },
            ...
            evaluationCriteria: {
              minAccuracyPercent: 80,
              targetPrecisionMs: 160,
              description: 'Ataque correto das notas do acorde com dedos firmes e curvados.',
            },
          },
          {
            id: 't4-1-ex2',
            title: 'Exercício 2: Tríades de Dó (C) e Fá (F) com Metrônomo',
            goal: 'Transição com pulso rítmico estrito entre C e F utilizando dedos 1, 3 e 5.',
            type: 'rhythm',
            bpm: 75,
            timeSignature: '4/4',
            scoreTrack: [
          ...
          { midi: 65, clef: 'treble', duration: 1, beat: 1, measure: 2, fingerRightHand: 1, noteName: 'F3' },
          ...
          { midi: 72, clef: 'treble', duration: 2, beat: 3, measure: 2, fingerRightHand: 5, noteName: 'C4' },
            ...
            evaluationCriteria: {
              minAccuracyPercent: 85,
              targetPrecisionMs: 130,
              description: 'Sincronizar a mudança dos acordes rigorosamente no tempo 1 do metrônomo.',
            },
          },
          {
            id: 't4-1-ex3',
            title: 'Exercício 3: Cadência I - IV - V (C - F - G)',
            goal: 'Executar a progressão dos 3 acordes maiores fundamentais no andamento.',
            type: 'phrase',
            bpm: 80,
            timeSignature: '4/4',
            accompanimentStyleId: 'pop-ballad',
          ...
          { midi: 60, clef: 'treble', duration: 4, beat: 1, measure: 4, fingerRightHand: 1, noteName: 'C3', chordName: 'C' },
            ...
            evaluationCriteria: {
              minAccuracyPercent: 85,
              targetPrecisionMs: 110,
              description: 'Execução harmônica completa com fluidez, sustentação e clareza de vozes.',
            },
          },
          {
            id: 't4-1-ex4',
            title: 'Exercício 4: Treinador de Montagem das Tríades Maiores',
            goal: 'Montar as tríades antes do tempo estipulado sem rigidez na mão.',
            type: 'chords',
            bpm: 75,
            timeSignature: '4/4',
            evaluationCriteria: {
              ...
              description: 'Posicionar o shape completo no teclado antes do cronômetro zerar.',
            },
          },
        ],
        targetChords: [
      ...
      },
      {
        ...
        durationMinutes: 12,
        instructions: {
          heading: 'A Magia da Terça Menor & A Afetividade Harmônica',
          text: 'O grau III (Mediante) é o coração emocional do acorde. Ao abaixar a terça em 1 semitom, a fundamental e a quinta permanecem inalteradas, mas a consonância ganha tom reflexivo e melancólico.',
          bulletPoints: [
            'Arquitetura Intervalar: Tríade menor é formada pela Tônica (I) + Terça Menor (bIII, 1,5 tom / 3 semitons) + Quinta Justa (V, 3,5 tons / 7 semitons).',
            'Relação Interna Invertida: Do I ao bIII há 1 tom e meio; do bIII ao V há 2 tons inteiros (o inverso da tríade maior).',
            'Exemplos Práticos: Dó Maior (C-E-G) ➔ Dó Menor (C-E♭-G); Ré Maior (D-F#-A) ➔ Ré Menor (D-F-A).',
            'Tríades Menores Naturais nas Teclas Brancas: Lá Menor (A-C-E), Ré Menor (D-F-A) e Mi Menor (E-G-B).',
          ],
          fingeringTip: 'O dedo 3 apenas escorrega para a tecla esquerda mais próxima (1 semitom abaixo).',
        },
        scoreTrack: [
          { midi: 69, clef: 'treble', duration: 1, beat: 1, measure: 1, fingerRightHand: 1, noteName: 'A3', chordName: 'Am' },
          { midi: 72, clef: 'treble', duration: 1, beat: 2, measure: 1, fingerRightHand: 3, noteName: 'C4', chordName: 'Am' },
          { midi: 76, clef: 'treble', duration: 2, beat: 3, measure: 1, fingerRightHand: 5, noteName: 'E4', chordName: 'Am' },
          { midi: 62, clef: 'treble', duration: 1, beat: 1, measure: 2, fingerRightHand: 1, noteName: 'D3', chordName: 'Dm' },
          { midi: 65, clef: 'treble', duration: 1, beat: 2, measure: 2, fingerRightHand: 3, noteName: 'F3', chordName: 'Dm' },
          { midi: 69, clef: 'treble', duration: 2, beat: 3, measure: 2, fingerRightHand: 5, noteName: 'A3', chordName: 'Dm' },
          { midi: 64, clef: 'treble', duration: 1, beat: 1, measure: 3, fingerRightHand: 1, noteName: 'E3', chordName: 'Em' },
          { midi: 67, clef: 'treble', duration: 1, beat: 2, measure: 3, fingerRightHand: 3, noteName: 'G3', chordName: 'Em' },
          { midi: 71, clef: 'treble', duration: 2, beat: 3, measure: 3, fingerRightHand: 5, noteName: 'B3', chordName: 'Em' },
          { midi: 69, clef: 'treble', duration: 4, beat: 1, measure: 4, fingerRightHand: 1, noteName: 'A3', chordName: 'Am' },
        ],
        exercises: [
          {
            id: 't4-2-ex1',
            title: 'Exercício 1: A Tríade de Lá Menor (A - C - E)',
            goal: 'Sentir o som da terça menor (1 tom e meio) em Lá Menor.',
            type: 'notes',
            bpm: 65,
            timeSignature: '4/4',
            scoreTrack: [
          { midi: 69, clef: 'treble', duration: 2, beat: 1, measure: 1, fingerRightHand: 1, noteName: 'A3' },
          { midi: 72, clef: 'treble', duration: 2, beat: 3, measure: 1, fingerRightHand: 3, noteName: 'C4' },
          { midi: 76, clef: 'treble', duration: 4, beat: 1, measure: 2, fingerRightHand: 5, noteName: 'E4' },
        ],
            evaluationCriteria: {
              minAccuracyPercent: 80,
              targetPrecisionMs: 160,
          ...
          {
            id: 't4-2-ex2',
            title: 'Exercício 2: Tríades de Am e Dm com Metrônomo',
            goal: 'Trocar suavemente entre Am e Dm no pulso uniforme do metrônomo.',
            type: 'rhythm',
            bpm: 75,
            timeSignature: '4/4',
            scoreTrack: [
          ...
          { midi: 62, clef: 'treble', duration: 1, beat: 1, measure: 2, fingerRightHand: 1, noteName: 'D3' },
          ...
          {
            id: 't4-2-ex3',
            title: 'Exercício 3: Ciclo das Tríades Menores (Am - Dm - Em)',
            goal: 'Tocar os arpejos dos três acordes menores do campo harmônico natural.',
            type: 'phrase',
            bpm: 80,
            timeSignature: '4/4',
            accompanimentStyleId: 'pop-ballad',
          ...
          {
            id: 't4-2-ex4',
            title: 'Exercício 4: Treinador de Montagem das Tríades Menores',
            goal: 'Montar os acordes menores com agilidade nos dedos 1, 3 e 5.',
            type: 'chords',
            bpm: 75,
            timeSignature: '4/4',
            evaluationCriteria: {
      ...
      },
      {
        ...
        exercises: [
          ...
          },
          {
            ...
            { midi: 43, clef: 'bass', duration: 1, beat: 4, measure: 2, fingerLeftHand: 5, noteName: 'G1', chordName: 'G' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 85,
              targetPrecisionMs: 130,
    ...
    lessons: [
      {
        ...
        durationMinutes: 15,
        instructions: {
          heading: 'O Conceito de Inversão em Tríades e Tétrades',
          text: 'A inversão de um acorde ocorre quando uma nota diferente da fundamental é tocada como a nota mais grave (o baixo). Tríades (3 notas) admitem 3 posições; tétrades (4 notas) admitem 4 posições.',
          bulletPoints: [
            'Estado Fundamental (C): Raiz no baixo (C - E - G), dedilhado 1-3-5. A nota mais grave é a própria tônica.',
            '1ª Inversão (C/E): Terça no baixo (E - G - C), dedilhado 1-2-5. A fundamental foi deslocada para o topo.',
            '2ª Inversão (C/G): Quinta no baixo (G - C - E), dedilhado 1-3-5. A terça foi deslocada para o topo.',
            'Inversões em Tétrades: Tétrades com 7ª adicionam a 3ª Inversão com a sétima no baixo (ex: C7M/B = B - C - E - G).',
            'Voice Leading no Teclado: Inverter acordes permite conectar harmonias com deslocamento mínimo das mãos, evitando saltos bruscos.',
          ],
          fingeringTip: 'Na 1ª inversão (E-G-C), use os dedos 1-2-5 para acomodar o intervalo de quarta entre Sol e Dó.',
        },
        scoreTrack: [
          { midi: 60, clef: 'treble', duration: 1, beat: 1, measure: 1, fingerRightHand: 1, noteName: 'C3', chordName: 'C' },
          { midi: 64, clef: 'treble', duration: 1, beat: 2, measure: 1, fingerRightHand: 3, noteName: 'E3', chordName: 'C' },
          { midi: 67, clef: 'treble', duration: 2, beat: 3, measure: 1, fingerRightHand: 5, noteName: 'G3', chordName: 'C' },
          { midi: 64, clef: 'treble', duration: 1, beat: 1, measure: 2, fingerRightHand: 1, noteName: 'E3', chordName: 'C/E' },
          { midi: 67, clef: 'treble', duration: 1, beat: 2, measure: 2, fingerRightHand: 2, noteName: 'G3', chordName: 'C/E' },
          { midi: 72, clef: 'treble', duration: 2, beat: 3, measure: 2, fingerRightHand: 5, noteName: 'C4', chordName: 'C/E' },
          { midi: 67, clef: 'treble', duration: 1, beat: 1, measure: 3, fingerRightHand: 1, noteName: 'G3', chordName: 'C/G' },
          { midi: 72, clef: 'treble', duration: 1, beat: 2, measure: 3, fingerRightHand: 3, noteName: 'C4', chordName: 'C/G' },
          { midi: 76, clef: 'treble', duration: 2, beat: 3, measure: 3, fingerRightHand: 5, noteName: 'E4', chordName: 'C/G' },
          { midi: 72, clef: 'treble', duration: 4, beat: 1, measure: 4, fingerRightHand: 1, noteName: 'C4', chordName: 'C' },
        ],
        exercises: [
          {
            id: 't5-1-ex1',
            title: 'Exercício 1: Posição Fundamental vs 1ª Inversão (C para C/E)',
            goal: 'Diferenciar o dedilhado 1-3-5 da fundamental do dedilhado 1-2-5 da primeira inversão.',
            type: 'notes',
            bpm: 65,
            timeSignature: '4/4',
            scoreTrack: [
          ...
          {
            id: 't5-1-ex2',
            title: 'Exercício 2: 1ª Inversão para 2ª Inversão (C/E para C/G)',
            goal: 'Dominar o salto de quarta da 2ª inversão (Sol - Dó - Mi).',
            type: 'rhythm',
            bpm: 75,
            timeSignature: '4/4',
            scoreTrack: [
          ...
          {
            id: 't5-1-ex3',
            title: 'Exercício 3: Ciclo Contínuo de Inversões Subindo o Teclado',
            goal: 'Tocar todas as 3 formas do mesmo acorde com fluidez ininterrupta.',
            type: 'phrase',
            bpm: 80,
            timeSignature: '4/4',
            accompanimentStyleId: 'pop-ballad',
          ...
          {
            id: 't5-1-ex4',
            title: 'Exercício 4: Treinador de Inversões com Dedo Âncora',
            goal: 'Treino de montagem rápida das inversões no teclado.',
            type: 'chords',
            bpm: 75,
            timeSignature: '4/4',
            evaluationCriteria: {
        ...
        exercises: [
          {
            ...
            { midi: 64, clef: 'treble', duration: 2, beat: 3, measure: 1, fingerRightHand: 3, noteName: 'E3' },
            { midi: 67, clef: 'treble', duration: 2, beat: 1, measure: 2, fingerRightHand: 5, noteName: 'G3' },
            { midi: 60, clef: 'treble', duration: 2, beat: 3, measure: 2, fingerRightHand: 1, noteName: 'C3', chordName: 'F/C' },
            { midi: 65, clef: 'treble', duration: 2, beat: 1, measure: 3, fingerRightHand: 3, noteName: 'F3' },
            { midi: 69, clef: 'treble', duration: 2, beat: 3, measure: 3, fingerRightHand: 5, noteName: 'A3' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 80,
          ...
          },
          {
            ...
            { midi: 64, clef: 'treble', duration: 1, beat: 2, measure: 1, fingerRightHand: 3, noteName: 'E3' },
            { midi: 67, clef: 'treble', duration: 1, beat: 3, measure: 1, fingerRightHand: 5, noteName: 'G3' },
            { midi: 60, clef: 'treble', duration: 1, beat: 4, measure: 1, fingerRightHand: 1, noteName: 'C3', chordName: 'F/C' },
            ...
            { midi: 59, clef: 'treble', duration: 1, beat: 3, measure: 2, fingerRightHand: 1, noteName: 'B2', chordName: 'G/B' },
            { midi: 62, clef: 'treble', duration: 1, beat: 4, measure: 2, fingerRightHand: 2, noteName: 'D3' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 85,
      ...
      },
      {
        ...
        exercises: [
          ...
          },
          {
            ...
            { midi: 64, clef: 'treble', duration: 1, beat: 2, measure: 2, fingerRightHand: 3, noteName: 'E3' },
            { midi: 67, clef: 'treble', duration: 1, beat: 3, measure: 2, fingerRightHand: 5, noteName: 'G3' },
            { midi: 43, clef: 'bass', duration: 1, beat: 4, measure: 2, fingerLeftHand: 1, noteName: 'G1', chordName: 'G' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 85,
              targetPrecisionMs: 130,
        ...
        exercises: [
          {
            ...
            { midi: 45, clef: 'bass', duration: 2, beat: 3, measure: 2, fingerLeftHand: 5, noteName: 'A1' },
            { midi: 52, clef: 'bass', duration: 2, beat: 1, measure: 3, fingerLeftHand: 2, noteName: 'E2' },
          ...
          },
          {
            ...
            { midi: 48, clef: 'bass', duration: 1, beat: 1, measure: 1, fingerLeftHand: 5, noteName: 'C2' },
            { midi: 55, clef: 'bass', duration: 1, beat: 2, measure: 1, fingerLeftHand: 2, noteName: 'G2' },
            { midi: 60, clef: 'bass', duration: 1, beat: 3, measure: 1, fingerLeftHand: 1, noteName: 'C3' },
            { midi: 45, clef: 'bass', duration: 1, beat: 4, measure: 1, fingerLeftHand: 5, noteName: 'A1' },
            { midi: 52, clef: 'bass', duration: 1, beat: 1, measure: 2, fingerLeftHand: 2, noteName: 'E2' },
            { midi: 57, clef: 'bass', duration: 1, beat: 2, measure: 2, fingerLeftHand: 1, noteName: 'A2' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 85,
              targetPrecisionMs: 130,
        ...
        exercises: [
          {
            ...
            { midi: 64, clef: 'treble', duration: 2, beat: 3, measure: 2, fingerRightHand: 3, noteName: 'E3' },
            { midi: 64, clef: 'treble', duration: 2, beat: 1, measure: 3, fingerRightHand: 3, noteName: 'E3' },
            { midi: 45, clef: 'bass', duration: 2, beat: 3, measure: 3, fingerLeftHand: 4, noteName: 'A1', chordName: 'Am' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 80,
              targetPrecisionMs: 160,
          ...
          },
          {
            ...
            { midi: 64, clef: 'treble', duration: 1, beat: 4, measure: 1, fingerRightHand: 3, noteName: 'E3' },
            { midi: 64, clef: 'treble', duration: 1, beat: 1, measure: 2, fingerRightHand: 3, noteName: 'E3' },
            { midi: 45, clef: 'bass', duration: 1, beat: 2, measure: 2, fingerLeftHand: 4, noteName: 'A1', chordName: 'Am' },
            { midi: 60, clef: 'treble', duration: 1, beat: 3, measure: 2, fingerRightHand: 1, noteName: 'C3' },
            { midi: 60, clef: 'treble', duration: 1, beat: 4, measure: 2, fingerRightHand: 1, noteName: 'C3' },
          ],
            evaluationCriteria: {
        ...
        exercises: [
          {
            ...
            timeSignature: '3/4',
            scoreTrack: [
            { midi: 48, clef: 'bass', duration: 1.5, beat: 1, measure: 1, fingerLeftHand: 5, noteName: 'C2', chordName: 'C' },
            { midi: 64, clef: 'treble', duration: 1.5, beat: 2.5, measure: 1, fingerRightHand: 3, noteName: 'E3' },
            { midi: 64, clef: 'treble', duration: 1.5, beat: 1, measure: 2, fingerRightHand: 3, noteName: 'E3' },
            { midi: 43, clef: 'bass', duration: 1.5, beat: 2.5, measure: 2, fingerLeftHand: 5, noteName: 'G1', chordName: 'G' },
            { midi: 62, clef: 'treble', duration: 1.5, beat: 1, measure: 3, fingerRightHand: 2, noteName: 'D3' },
            { midi: 62, clef: 'treble', duration: 1.5, beat: 2.5, measure: 3, fingerRightHand: 2, noteName: 'D3' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 80,
              targetPrecisionMs: 160,
  ...
  // -------------------------------------------------------------
  {
    ...
    lessons: [
        ...
        exercises: [
          {
            ...
            { midi: 67, clef: 'treble', duration: 2, beat: 1, measure: 3, fingerRightHand: 2, noteName: 'G3' },
            { midi: 69, clef: 'treble', duration: 2, beat: 3, measure: 3, fingerRightHand: 3, noteName: 'A3' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 80,
              targetPrecisionMs: 160,
      ...
      },
      {
        ...
        durationMinutes: 15,
        instructions: {
          heading: 'A Importância das Escalas & A Fórmula T-T-S-T-T-T-S',
          text: 'Conhecer as escalas maiores e menores é o pilar mestre do tecladista: a escala dita diretamente o Campo Harmônico (a sequência de acordes da música) e funciona como o mapa topográfico dos dedos nas teclas brancas e pretas.',
          bulletPoints: [
            'Geração do Campo Harmônico: Se a escala utiliza apenas notas naturais, seus acordes serão naturais; ao surgir um acidente na escala (Fá# em Sol Maior), todos os acordes do campo herdam essa alteração (G, Am, Bm, C, D, Em, F#º).',
            'Fórmula da Escala Maior: Tom - Tom - Semitom - Tom - Tom - Tom - Semitom.',
            'Para manter essa fórmula a partir de Sol (G), o 7º grau precisa ser elevado em meio tom: Fá sustenido (F#).',
            'O Fá# é atacado pelo dedo 4 na tecla preta, atuando como a Sensível que conduz o ouvido para a resolução na tônica Sol.',
            'Leitura de Armaduras: Saber a escala permite tocar fluentemente sem precisar decifrar cada acidente nota por nota.',
          ],
        ...
        exercises: [
          {
            ...
            timeSignature: '4/4',
            scoreTrack: [
            { midi: 67, clef: 'treble', duration: 2, beat: 1, measure: 1, fingerRightHand: 1, noteName: 'G3' },
            { midi: 69, clef: 'treble', duration: 2, beat: 3, measure: 1, fingerRightHand: 2, noteName: 'A3' },
            { midi: 71, clef: 'treble', duration: 2, beat: 1, measure: 2, fingerRightHand: 3, noteName: 'B3' },
            { midi: 72, clef: 'treble', duration: 2, beat: 3, measure: 2, fingerRightHand: 1, noteName: 'C4' },
            { midi: 74, clef: 'treble', duration: 2, beat: 1, measure: 3, fingerRightHand: 2, noteName: 'D4' },
        ...
        exercises: [
          {
            ...
            scoreTrack: [
            { midi: 60, clef: 'treble', duration: 2, beat: 1, measure: 1, fingerRightHand: 1, noteName: 'C3' },
            { midi: 64, clef: 'treble', duration: 2, beat: 3, measure: 1, fingerRightHand: 2, noteName: 'E3' },
            { midi: 65, clef: 'treble', duration: 2, beat: 1, measure: 2, fingerRightHand: 3, noteName: 'F3' },
            { midi: 67, clef: 'treble', duration: 2, beat: 3, measure: 2, fingerRightHand: 4, noteName: 'G3' },
            { midi: 69, clef: 'treble', duration: 2, beat: 1, measure: 3, fingerRightHand: 5, noteName: 'A3' },
            { midi: 67, clef: 'treble', duration: 2, beat: 3, measure: 3, fingerRightHand: 4, noteName: 'G3' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 80,
              targetPrecisionMs: 160,
          ...
          },
          {
            ...
            { midi: 64, clef: 'treble', duration: 1, beat: 4, measure: 2, fingerRightHand: 2, noteName: 'E3' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 85,
              targetPrecisionMs: 130,
    ...
    lessons: [
      {
        ...
        durationMinutes: 16,
        instructions: {
          heading: 'Arquitetura das Tétrades & Inversões com Sétima',
          text: 'Uma tétrade é um acorde de 4 notas formado pelos graus I, III, V e VII. No teclado, produzem textura harmônica sofisticada e admitem 4 posições (fundamental, 1ª, 2ª e 3ª inversão).',
          bulletPoints: [
            'Sétima Maior (maj7): Fundamental + 3ª Maior + 5ª Justa + 7ª Maior (1 semitom abaixo da oitava). Exemplo em C: C - E - G - B.',
            'Sétima Dominante (7): Fundamental + 3ª Maior + 5ª Justa + 7ª Menor (2 semitons abaixo da oitava). Exemplo em G: G - B - D - F.',
            'Menor com Sétima (m7): Tríade menor + 7ª Menor. Exemplo em A: A - C - E - G.',
            '3ª Inversão de Tétrades: Ocorre quando a 7ª é posicionada no baixo (ex: C7M/B = B no baixo, dedilhado B-C-E-G), criando uma linha de baixo melódica cromática descendente.',
          ],
          fingeringTip: 'Dedos 1-2-3-5 na mão direita para tétrades na posição fundamental.',
        },
        scoreTrack: [
          { midi: 60, clef: 'treble', duration: 1, beat: 1, measure: 1, fingerRightHand: 1, noteName: 'C3', chordName: 'Cmaj7' },
          { midi: 64, clef: 'treble', duration: 1, beat: 2, measure: 1, fingerRightHand: 2, noteName: 'E3', chordName: 'Cmaj7' },
          { midi: 67, clef: 'treble', duration: 1, beat: 3, measure: 1, fingerRightHand: 3, noteName: 'G3', chordName: 'Cmaj7' },
          { midi: 71, clef: 'treble', duration: 1, beat: 4, measure: 1, fingerRightHand: 5, noteName: 'B3', chordName: 'Cmaj7' },
          { midi: 67, clef: 'treble', duration: 1, beat: 1, measure: 2, fingerRightHand: 1, noteName: 'G3', chordName: 'G7' },
          { midi: 71, clef: 'treble', duration: 1, beat: 2, measure: 2, fingerRightHand: 2, noteName: 'B3', chordName: 'G7' },
          { midi: 74, clef: 'treble', duration: 1, beat: 3, measure: 2, fingerRightHand: 4, noteName: 'D4', chordName: 'G7' },
          { midi: 77, clef: 'treble', duration: 1, beat: 4, measure: 2, fingerRightHand: 5, noteName: 'F4', chordName: 'G7' },
          { midi: 60, clef: 'treble', duration: 4, beat: 1, measure: 3, fingerRightHand: 1, noteName: 'C3', chordName: 'Cmaj7' },
        ],
        exercises: [
          {
            id: 't8-1-ex1',
            title: 'Exercício 1: A Sétima Maior em Cmaj7 (C - E - G - B)',
            goal: 'Tocar a tétrade Cmaj7 com os dedos 1-2-3-5 sem colapsar as juntas.',
            type: 'notes',
            bpm: 65,
            timeSignature: '4/4',
            scoreTrack: [
          ...
          { midi: 71, clef: 'treble', duration: 2, beat: 3, measure: 2, fingerRightHand: 5, noteName: 'B3' },
        ],
            evaluationCriteria: {
              minAccuracyPercent: 80,
              targetPrecisionMs: 160,
          ...
          {
            id: 't8-1-ex2',
            title: 'Exercício 2: A Sétima Menor/Dominante em G7 (G - B - D - F)',
            goal: 'Ouvir a tensão resolutiva do trítono no acorde G7.',
            type: 'rhythm',
            bpm: 75,
            timeSignature: '4/4',
            scoreTrack: [
          { midi: 67, clef: 'treble', duration: 1, beat: 1, measure: 1, fingerRightHand: 1, noteName: 'G3' },
          { midi: 71, clef: 'treble', duration: 1, beat: 2, measure: 1, fingerRightHand: 2, noteName: 'B3' },
          { midi: 74, clef: 'treble', duration: 1, beat: 3, measure: 1, fingerRightHand: 4, noteName: 'D4' },
          { midi: 77, clef: 'treble', duration: 1, beat: 4, measure: 1, fingerRightHand: 5, noteName: 'F4' },
          { midi: 60, clef: 'treble', duration: 4, beat: 1, measure: 2, fingerRightHand: 1, noteName: 'C3' },
        ],
            evaluationCriteria: {
              minAccuracyPercent: 85,
              targetPrecisionMs: 130,
          ...
          {
            id: 't8-1-ex3',
            title: 'Exercício 3: Cadência Jazz com Sétimas (Cmaj7 para G7)',
            goal: 'Conectar tétrades em andamento uniforme de 80 BPM.',
            type: 'phrase',
            bpm: 80,
            timeSignature: '4/4',
            accompanimentStyleId: 'pop-ballad',
          ...
          {
            id: 't8-1-ex4',
            title: 'Exercício 4: Treinador de Montagem de Tétrades (maj7 e 7)',
            goal: 'Montar tétrades com sétima com precisão neuromuscular.',
            type: 'chords',
            bpm: 75,
            timeSignature: '4/4',
            evaluationCriteria: {
      ...
      },
      {
        ...
        scoreTrack: [
          { midi: 60, clef: 'treble', duration: 1, beat: 1, measure: 1, fingerRightHand: 1, noteName: 'C3', chordName: 'Csus4' },
          { midi: 65, clef: 'treble', duration: 1, beat: 2, measure: 1, fingerRightHand: 3, noteName: 'F3', chordName: 'Csus4' },
          { midi: 67, clef: 'treble', duration: 2, beat: 3, measure: 1, fingerRightHand: 5, noteName: 'G3', chordName: 'Csus4' },
          { midi: 60, clef: 'treble', duration: 1, beat: 1, measure: 2, fingerRightHand: 1, noteName: 'C3', chordName: 'Csus2' },
          { midi: 62, clef: 'treble', duration: 1, beat: 2, measure: 2, fingerRightHand: 2, noteName: 'D3', chordName: 'Csus2' },
          { midi: 67, clef: 'treble', duration: 2, beat: 3, measure: 2, fingerRightHand: 5, noteName: 'G3', chordName: 'Csus2' },
          { midi: 60, clef: 'treble', duration: 1, beat: 1, measure: 3, fingerRightHand: 1, noteName: 'C3', chordName: 'Cadd9' },
          { midi: 62, clef: 'treble', duration: 1, beat: 2, measure: 3, fingerRightHand: 2, noteName: 'D3', chordName: 'Cadd9' },
          { midi: 64, clef: 'treble', duration: 1, beat: 3, measure: 3, fingerRightHand: 3, noteName: 'E3', chordName: 'Cadd9' },
          { midi: 67, clef: 'treble', duration: 1, beat: 4, measure: 3, fingerRightHand: 5, noteName: 'G3', chordName: 'Cadd9' },
          { midi: 60, clef: 'treble', duration: 4, beat: 1, measure: 4, fingerRightHand: 1, noteName: 'C3', chordName: 'C' },
        ],
        exercises: [
          {
            id: 't8-2-ex1',
            title: 'Exercício 1: A Suspensão Csus4 (C - F - G)',
            goal: 'Ouvir a suspensão da 4ª justa e sua tensão em direção à terça.',
            type: 'notes',
            bpm: 65,
            timeSignature: '4/4',
            scoreTrack: [
          ...
          {
            id: 't8-2-ex2',
            title: 'Exercício 2: O Espaço Sonoro de Csus2 (C - D - G)',
            goal: 'Articular o dedo 2 na nota Ré mantendo o polegar no Dó.',
            type: 'rhythm',
            bpm: 75,
            timeSignature: '4/4',
            scoreTrack: [
          ...
          {
            id: 't8-2-ex3',
            title: 'Exercício 3: Textura Contemporânea com Cadd9',
            goal: 'Executar o acorde Cadd9 com 4 vozes claras e equilibradas.',
            type: 'phrase',
            bpm: 80,
            timeSignature: '4/4',
            accompanimentStyleId: 'pop-ballad',
          ...
          {
            id: 't8-2-ex4',
            title: 'Exercício 4: Treinador de Acordes Sus e Add9',
            goal: 'Montagem rápida dos acordes worship contemporâneos.',
            type: 'chords',
            bpm: 75,
            timeSignature: '4/4',
            evaluationCriteria: {
        ...
        exercises: [
          {
            ...
            timeSignature: '4/4',
            scoreTrack: [
            { midi: 50, clef: 'bass', duration: 2, beat: 1, measure: 1, fingerLeftHand: 5, noteName: 'D2', chordName: 'Dm7' },
            { midi: 65, clef: 'treble', duration: 2, beat: 3, measure: 1, fingerRightHand: 1, noteName: 'F3' },
            { midi: 69, clef: 'treble', duration: 2, beat: 1, measure: 2, fingerRightHand: 3, noteName: 'A3' },
            { midi: 72, clef: 'treble', duration: 2, beat: 3, measure: 2, fingerRightHand: 5, noteName: 'C4' },
            { midi: 43, clef: 'bass', duration: 2, beat: 1, measure: 3, fingerLeftHand: 5, noteName: 'G1', chordName: 'G7' },
            { midi: 65, clef: 'treble', duration: 2, beat: 3, measure: 3, fingerRightHand: 1, noteName: 'F3' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 80,
              targetPrecisionMs: 160,
          ...
          },
          {
            ...
            timeSignature: '4/4',
            scoreTrack: [
            { midi: 50, clef: 'bass', duration: 1, beat: 1, measure: 1, fingerLeftHand: 5, noteName: 'D2', chordName: 'Dm7' },
            { midi: 65, clef: 'treble', duration: 1, beat: 2, measure: 1, fingerRightHand: 1, noteName: 'F3' },
            { midi: 69, clef: 'treble', duration: 1, beat: 3, measure: 1, fingerRightHand: 3, noteName: 'A3' },
            { midi: 72, clef: 'treble', duration: 1, beat: 4, measure: 1, fingerRightHand: 5, noteName: 'C4' },
            { midi: 43, clef: 'bass', duration: 1, beat: 1, measure: 2, fingerLeftHand: 5, noteName: 'G1', chordName: 'G7' },
            { midi: 65, clef: 'treble', duration: 1, beat: 2, measure: 2, fingerRightHand: 1, noteName: 'F3' },
            { midi: 67, clef: 'treble', duration: 1, beat: 3, measure: 2, fingerRightHand: 2, noteName: 'G3' },
            { midi: 71, clef: 'treble', duration: 1, beat: 4, measure: 2, fingerRightHand: 4, noteName: 'B3' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 85,
              targetPrecisionMs: 130,
        ...
        exercises: [
          {
            ...
            scoreTrack: [
            { midi: 60, clef: 'treble', duration: 2, beat: 1, measure: 1, fingerRightHand: 1, noteName: 'C3' },
            { midi: 63, clef: 'treble', duration: 2, beat: 3, measure: 1, fingerRightHand: 2, noteName: 'Eb3' },
            { midi: 65, clef: 'treble', duration: 2, beat: 1, measure: 2, fingerRightHand: 3, noteName: 'F3' },
            { midi: 66, clef: 'treble', duration: 2, beat: 3, measure: 2, fingerRightHand: 4, noteName: 'F#3' },
            { midi: 67, clef: 'treble', duration: 2, beat: 1, measure: 3, fingerRightHand: 1, noteName: 'G3' },
            { midi: 70, clef: 'treble', duration: 2, beat: 3, measure: 3, fingerRightHand: 3, noteName: 'Bb3' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 80,
              targetPrecisionMs: 160,
          ...
          },
          {
            ...
            { midi: 63, clef: 'treble', duration: 1, beat: 2, measure: 1, fingerRightHand: 2, noteName: 'Eb3' },
            { midi: 65, clef: 'treble', duration: 1, beat: 3, measure: 1, fingerRightHand: 3, noteName: 'F3' },
            { midi: 66, clef: 'treble', duration: 1, beat: 4, measure: 1, fingerRightHand: 4, noteName: 'F#3' },
            { midi: 67, clef: 'treble', duration: 1, beat: 1, measure: 2, fingerRightHand: 1, noteName: 'G3' },
            { midi: 70, clef: 'treble', duration: 1, beat: 2, measure: 2, fingerRightHand: 3, noteName: 'Bb3' },
            { midi: 72, clef: 'treble', duration: 1, beat: 3, measure: 2, fingerRightHand: 5, noteName: 'C4' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 85,
              targetPrecisionMs: 130,
        ...
        exercises: [
          {
            ...
            { midi: 48, clef: 'bass', duration: 2, beat: 1, measure: 1, fingerLeftHand: 5, noteName: 'C2' },
            { midi: 55, clef: 'bass', duration: 2, beat: 3, measure: 1, fingerLeftHand: 1, noteName: 'G2' },
            { midi: 48, clef: 'bass', duration: 2, beat: 1, measure: 2, fingerLeftHand: 5, noteName: 'C2' },
            { midi: 57, clef: 'bass', duration: 2, beat: 3, measure: 2, fingerLeftHand: 1, noteName: 'A2' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 80,
        ...
        exercises: [
          {
            ...
            timeSignature: '4/4',
            scoreTrack: [
            { midi: 41, clef: 'bass', duration: 2, beat: 1, measure: 1, fingerLeftHand: 5, noteName: 'F1' },
            { midi: 69, clef: 'treble', duration: 2, beat: 3, measure: 1, fingerRightHand: 3, noteName: 'A3', chordName: 'Fmaj7' },
            { midi: 67, clef: 'treble', duration: 2, beat: 1, measure: 2, fingerRightHand: 2, noteName: 'G3' },
            { midi: 67, clef: 'treble', duration: 2, beat: 3, measure: 2, fingerRightHand: 2, noteName: 'G3' },
            { midi: 64, clef: 'treble', duration: 2, beat: 1, measure: 3, fingerRightHand: 1, noteName: 'E3' },
            { midi: 43, clef: 'bass', duration: 2, beat: 3, measure: 3, fingerLeftHand: 5, noteName: 'G1' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 80,
              targetPrecisionMs: 160,
          ...
          },
          {
            ...
            timeSignature: '4/4',
            scoreTrack: [
            { midi: 41, clef: 'bass', duration: 1, beat: 1, measure: 1, fingerLeftHand: 5, noteName: 'F1' },
            { midi: 69, clef: 'treble', duration: 1, beat: 2, measure: 1, fingerRightHand: 3, noteName: 'A3', chordName: 'Fmaj7' },
            { midi: 67, clef: 'treble', duration: 1, beat: 3, measure: 1, fingerRightHand: 2, noteName: 'G3' },
            { midi: 67, clef: 'treble', duration: 1, beat: 4, measure: 1, fingerRightHand: 2, noteName: 'G3' },
            { midi: 64, clef: 'treble', duration: 1, beat: 1, measure: 2, fingerRightHand: 1, noteName: 'E3' },
            { midi: 43, clef: 'bass', duration: 1, beat: 2, measure: 2, fingerLeftHand: 5, noteName: 'G1' },
            { midi: 67, clef: 'treble', duration: 1, beat: 3, measure: 2, fingerRightHand: 2, noteName: 'G3', chordName: 'G7' },
            { midi: 65, clef: 'treble', duration: 1, beat: 4, measure: 2, fingerRightHand: 1, noteName: 'F3' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 85,
              targetPrecisionMs: 130,
        ...
        exercises: [
          {
            ...
            { midi: 59, clef: 'treble', duration: 2, beat: 1, measure: 2, fingerRightHand: 1, noteName: 'B2', chordName: 'G' },
            { midi: 43, clef: 'bass', duration: 2, beat: 3, measure: 2, fingerLeftHand: 5, noteName: 'G1' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 80,
              targetPrecisionMs: 160,
          ...
          },
          {
            ...
            scoreTrack: [
            { midi: 60, clef: 'treble', duration: 1, beat: 1, measure: 1, fingerRightHand: 1, noteName: 'C3', chordName: 'C' },
            { midi: 48, clef: 'bass', duration: 1, beat: 2, measure: 1, fingerLeftHand: 5, noteName: 'C2' },
            { midi: 59, clef: 'treble', duration: 1, beat: 3, measure: 1, fingerRightHand: 1, noteName: 'B2', chordName: 'G' },
            { midi: 43, clef: 'bass', duration: 1, beat: 4, measure: 1, fingerLeftHand: 5, noteName: 'G1' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 85,
              targetPrecisionMs: 130,
        ...
        exercises: [
          {
            ...
            { midi: 64, clef: 'treble', duration: 2, beat: 1, measure: 2, fingerRightHand: 3, noteName: 'E3' },
            { midi: 67, clef: 'treble', duration: 2, beat: 3, measure: 2, fingerRightHand: 5, noteName: 'G3' },
            { midi: 72, clef: 'treble', duration: 2, beat: 1, measure: 3, fingerRightHand: 5, noteName: 'C4' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 80,
              targetPrecisionMs: 160,
        ...
        exercises: [
          {
            ...
            { midi: 75, clef: 'treble', duration: 2, beat: 3, measure: 1, fingerRightHand: 4, noteName: 'D#4' },
            { midi: 76, clef: 'treble', duration: 2, beat: 1, measure: 2, fingerRightHand: 5, noteName: 'E4' },
            { midi: 75, clef: 'treble', duration: 2, beat: 3, measure: 2, fingerRightHand: 4, noteName: 'D#4' },
            { midi: 76, clef: 'treble', duration: 2, beat: 1, measure: 3, fingerRightHand: 5, noteName: 'E4' },
            { midi: 71, clef: 'treble', duration: 2, beat: 3, measure: 3, fingerRightHand: 2, noteName: 'B3' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 80,
              targetPrecisionMs: 160,
          ...
          },
          {
            ...
            timeSignature: '4/4',
            scoreTrack: [
            { midi: 76, clef: 'treble', duration: 1, beat: 1, measure: 1, fingerRightHand: 5, noteName: 'E4' },
            { midi: 75, clef: 'treble', duration: 1, beat: 2, measure: 1, fingerRightHand: 4, noteName: 'D#4' },
            { midi: 76, clef: 'treble', duration: 1, beat: 3, measure: 1, fingerRightHand: 5, noteName: 'E4' },
            { midi: 75, clef: 'treble', duration: 1, beat: 4, measure: 1, fingerRightHand: 4, noteName: 'D#4' },
            ...
            { midi: 74, clef: 'treble', duration: 1, beat: 3, measure: 2, fingerRightHand: 4, noteName: 'D4' },
            { midi: 72, clef: 'treble', duration: 1, beat: 4, measure: 2, fingerRightHand: 3, noteName: 'C4' },
          ],
            evaluationCriteria: {
              minAccuracyPercent: 85,
              targetPrecisionMs: 130,
