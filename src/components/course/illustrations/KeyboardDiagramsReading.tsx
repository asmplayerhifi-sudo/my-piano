...
/** 1. Leitura na Clave de Sol (t2-1: 5 Linhas, 4 Espaços & Dó Central C3/C4) */
    ...
    <svg viewBox="0 0 960 250" className="w-full h-auto rounded-2xl bg-[#070714] border border-white/10 select-none shadow-xl">
      ...
      <g transform="translate(30, 16)">
        ...
        <text x="0" y="34" fill="#94a3b8" fontSize="11">
          Mnemônico das 5 Linhas: "Minha Sorte Sempre Rende Frutos" • Partindo do Dó Central ({std})
        </text>
      </g>
      ...
      <g transform="translate(50, 68)">
        ...
        {/* Dó Central na Linha Suplementar Inferior */}
        <g transform="translate(105, 0)">
          ...
          <text x="0" y="136" textAnchor="middle" fill="#38bdf8" fontSize="11" fontWeight="black">★ {std}</text>
          <text x="0" y="174" textAnchor="middle" fill="#7dd3fc" fontSize="9" fontWeight="bold">Dó Central</text>
        </g>

        {/* Linhas */}
        {[
          { x: 210, y: 128, name: `Mi${3+d} (E${3+d})`, l: '1ª Linha', c: '#6366f1' },
          { x: 320, y: 102, name: `Sol${3+d} (G${3+d})`, l: '2ª Linha (Chave)', c: '#38bdf8' },
          { x: 430, y: 76, name: `Si${3+d} (B${3+d})`, l: '3ª Linha', c: '#10b981' },
          { x: 540, y: 50, name: `Ré${4+d} (D${4+d})`, l: '4ª Linha', c: '#f59e0b' },
          { x: 650, y: 24, name: `Fá${4+d} (F${4+d})`, l: '5ª Linha', c: '#f43f5e' },
        ].map((n, i) => (
          <g key={i}>
        ...
        <g transform="translate(730, 10)">
          ...
          <text x="18" y="48" fill="#e2e8f0" fontSize="10">• 4º E: Mi{4+d} (E{4+d})</text>
          <text x="18" y="70" fill="#e2e8f0" fontSize="10">• 3º E: Dó{4+d} (C{4+d})</text>
          <text x="18" y="92" fill="#e2e8f0" fontSize="10">• 2º E: Lá{3+d} (A{3+d})</text>
          <text x="18" y="114" fill="#e2e8f0" fontSize="10">• 1º E: Fá{3+d} (F{3+d})</text>
        </g>
      </g>
    </svg>
  );
...
/** 2. Leitura na Clave de Fá (t3-1: 5 Linhas, 4 Espaços & Dó Central C3/C4) */
  ...
  return (
    <svg viewBox="0 0 960 250" className="w-full h-auto rounded-2xl bg-[#070714] border border-white/10 select-none shadow-xl">
      ...
      <g transform="translate(30, 16)">
        ...
        <text x="0" y="34" fill="#94a3b8" fontSize="11">
          Os 2 pontos abraçam a 4ª linha (Fá{2+d} / F{2+d}) • O Dó Central {std} repousa na linha suplementar superior
        </text>
      </g>
      ...
      <g transform="translate(50, 68)">
        ...
        {/* Linhas */}
        {[
          { x: 130, y: 128, name: `Sol${1+d} (G${1+d})`, l: '1ª Linha', c: '#10b981' },
          { x: 240, y: 102, name: `Si${1+d} (B${1+d})`, l: '2ª Linha', c: '#06b6d4' },
          { x: 350, y: 76, name: `Ré${2+d} (D${2+d})`, l: '3ª Linha', c: '#818cf8' },
          { x: 460, y: 50, name: `Fá${2+d} (F${2+d})`, l: '4ª Linha (Foco)', c: '#f59e0b' },
          { x: 570, y: 24, name: `Lá${2+d} (A${2+d})`, l: '5ª Linha', c: '#f43f5e' },
        ].map((n, i) => (
          <g key={i}>
            <ellipse cx={n.x} cy={n.y} rx="13" ry="9" fill={n.c} transform={`rotate(-20 ${n.x} ${n.y})`} />
            <text x={n.x} y={n.y - 15} textAnchor="middle" fill="#ffffff" fontSize="11" fontWeight="bold">{n.name}</text>
        ...
        {/* Dó Central na Linha Suplementar Superior */}
        <g transform="translate(660, 0)">
          ...
          <text x="0" y="-18" textAnchor="middle" fill="#38bdf8" fontSize="11" fontWeight="black">★ {std}</text>
        ...
        <g transform="translate(730, 10)">
          ...
          <text x="18" y="48" fill="#e2e8f0" fontSize="10">• 4º E: Sol{2+d} (G{2+d})</text>
          <text x="18" y="70" fill="#e2e8f0" fontSize="10">• 3º E: Mi{2+d} (E{2+d})</text>
          <text x="18" y="92" fill="#e2e8f0" fontSize="10">• 2º E: Dó{2+d} (C{2+d})</text>
          <text x="18" y="114" fill="#e2e8f0" fontSize="10">• 1º E: Lá{1+d} (A{1+d})</text>
        </g>
      </g>
    </svg>
  );
